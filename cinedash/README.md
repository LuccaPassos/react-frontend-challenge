![Logo do CineDash](./src/shared/assets/cinedash-logo.svg)
...
Dentro de [ARCHITECTURE.md](./ARCHITECTURE.md) há mais detalhes sobre a implementação e em [INSTRUCTIONS.md](./INSTRUCTIONS.md) estão as instruções para executar o projeto.
